...
export type Channel = 'naver' | 'google' | 'meta' | 'youtube' | 'viral' | 'danggeun' | 'kakao_search' | 'kakao_moment' | 'chatgpt' | 'direct' | 'tu_albarich' | 'tu_youtube' | 'tu_danggeun' | 'hugreen_danggeun' | 'hugreen_mail' | 'inbound_call' | 'etc'
